...
def ticket():
    ...
    try:
        ...
        student_doc = frappe.db.get_value("HS Students", {"name": studentId}, ["name", "student_name"], as_dict=True)
        ...
        student_name = student_doc.student_name if student_doc else None
